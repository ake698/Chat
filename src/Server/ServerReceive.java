        ...
        while (!isStop && !client.socket.isClosed()) {
            try {
                ...
                if (type.equalsIgnoreCase("聊天信息")) {
                    ...
                    textarea.append(df.format(new Date())+"  "+msg);
...
//System.out.println("###"+e); 
                ...
                } else if (type.equalsIgnoreCase("用户下线") || type.equalsIgnoreCase("T出用户")) {
                    Node node = userLinkList.findUser(client.username);
                    userLinkList.delUser(node);
                    String msg;
                    if(type.equalsIgnoreCase("用户下线")){
                        msg = "用户 " + client.username + " 下线\n";
                    }else{
                        msg = "已将用户 " + client.username + " 踢出成功！！\n";
                    }
